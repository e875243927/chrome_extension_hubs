export const accelerationTable = {
    ...
    'language': {
        ...
        'zh-CN': {
            'meter_per_second_squared': '米每秒平方 (m/s²)',
            'kilometer_per_second_squared': '千米每秒平方 (km/s²)',
            'kilometer_per_hour_squared': '千米每小时平方 (km/h²)',
            'kilometer_per_hour_per_second': '千米每小时每秒 (km/h/s)',
            'centimeter_per_second_squared': '厘米每秒平方 (cm/s²)',
            'millimeter_per_second_squared': '毫米每秒平方 (mm/s²)',
            'micrometer_per_second_squared': '微米每秒平方 (μm/s²)',
            'nanometer_per_second_squared': '纳米每秒平方 (nm/s²)',
            'foot_per_second_squared': '英尺每秒平方 (ft/s²)',
            'inch_per_second_squared': '英寸每秒平方 (in/s²)',
            'yard_per_second_squared': '码每秒平方 (yd/s²)',
            'mile_per_second_squared': '英里每秒平方 (mile/s²)',
            'mile_per_hour_squared': '英里每小时平方 (mph²)',
            'mile_per_hour_per_second': '英里每小时每秒 (mph/s)',
            'standard_gravity': '标准重力 (g)',
            'earth_gravity': '地球重力 (g0)',
            'milligravity': '毫重力 (mg)',
            'microgravity': '微重力 (μg)',
            'nanogravity': '纳重力 (ng)',
            'gal': '伽 (Gal)',
            ...
            'radian_per_second_squared': '弧度每秒平方 (rad/s²)',
            'degree_per_second_squared': '度每秒平方 (°/s²)',
            'revolution_per_second_squared': '转每秒平方 (rps²)',
            'revolution_per_minute_squared': '转每分钟平方 (rpm²)',
            'revolution_per_minute_per_second': '转每分钟每秒 (rpm/s)',
            'knot_per_second': '节每秒 (knot/s)',
            'mach_per_second': '马赫每秒 (Mach/s)',
            'g_force': '重力加速度 (G)',
            'head_injury_criterion': '头部受伤标准 (HIC)',
            'whiplash_threshold': '颈部受伤阈值',
            'meter_per_minute_squared': '米每分钟平方 (m/min²)',
            'meter_per_hour_squared': '米每小时平方 (m/h²)',
            'foot_per_minute_squared': '英尺每分钟平方 (ft/min²)',
            'foot_per_hour_squared': '英尺每小时平方 (ft/h²)',
            'parsec_per_year_squared': '光年每年平方 (pc/year²)',    
            'light_year_per_year_squared': '光年每年平方 (ly/year²)',
            'astronomical_unit_per_year_squared': '天文单位每年平方 (AU/year²)',
            'atomic_unit_acceleration': '原子单位加速度 (au)',
            'planck_acceleration': '普朗克加速度 (a_P)',
            'galileo': '加利利 (Galileo)',
            'leo': '莱欧 (Leo)',
            'jerk_unit': '加速度单位 (m/s³)',
        ...
        'ja': {
            'meter_per_second_squared': 'メートル/秒平方 (m/s²)',
            'kilometer_per_second_squared': 'キロメートル/秒平方 (km/s²)',
            'kilometer_per_hour_squared': 'キロメートル/時間平方 (km/h²)',
            'kilometer_per_hour_per_second': 'キロメートル/時間/秒 (km/h/s)',
            'centimeter_per_second_squared': 'センチメートル/秒平方 (cm/s²)',
            'millimeter_per_second_squared': 'ミリメートル/秒平方 (mm/s²)',
            'micrometer_per_second_squared': 'マイクロメートル/秒平方 (μm/s²)',
            'nanometer_per_second_squared': 'ナノメートル/秒平方 (nm/s²)',
            'foot_per_second_squared': 'フット/秒平方 (ft/s²)',
            'inch_per_second_squared': 'インチ/秒平方 (in/s²)',
            'yard_per_second_squared': 'ヤード/秒平方 (yd/s²)',
            'mile_per_second_squared': 'マイル/秒平方 (mile/s²)',
            'mile_per_hour_squared': 'マイル/時間平方 (mph²)',
            'mile_per_hour_per_second': 'マイル/時間/秒 (mph/s)',
            'standard_gravity': '標準重力 (g)',
            'earth_gravity': '地球重力 (g0)',
            'milligravity': 'ミリ重力 (mg)',
            'microgravity': 'マイクロ重力 (μg)',
            'nanogravity': 'ナノ重力 (ng)',
            'gal': 'ガル (Gal)',
            'milligal': 'ミリガル (mGal)',
            'microgal': 'マイクロガル (μGal)',
            'eotvos': 'エトボス (E)',
            'radian_per_second_squared': 'ラジアン/秒平方 (rad/s²)',            
            'degree_per_second_squared': '度/秒平方 (°/s²)',
            'revolution_per_second_squared': '回/秒平方 (rps²)',
            'revolution_per_minute_squared': '回/分平方 (rpm²)',
            'revolution_per_minute_per_second': '回/分/秒 (rpm/s)',
            'knot_per_second': 'ノット/秒 (knot/s)',
            'mach_per_second': 'マッハ/秒 (Mach/s)',
            'g_force': '重力加速度 (G)',
            'head_injury_criterion': '頭部受傷標準 (HIC)',
            'whiplash_threshold': '頸部受傷閾値',
            'meter_per_minute_squared': 'メートル/分平方 (m/min²)',
            'meter_per_hour_squared': 'メートル/時間平方 (m/h²)',
            'foot_per_minute_squared': 'フット/分平方 (ft/min²)',
            'foot_per_hour_squared': 'フット/時間平方 (ft/h²)',
            'parsec_per_year_squared': '光年/年平方 (pc/year²)',    
            'light_year_per_year_squared': '光年/年平方 (ly/year²)',
            'astronomical_unit_per_year_squared': '天文単位/年平方 (AU/year²)',
            'atomic_unit_acceleration': '原子单位加速度 (au)',
            'planck_acceleration': '普朗克加速度 (a_P)',
            'galileo': '加利利 (Galileo)',
            'leo': '莱欧 (Leo)',
