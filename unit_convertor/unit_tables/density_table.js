export const densityTable = {
    ...
    'language': {
        ...
        'zh-CN': {
            'kilogram_per_cubic_meter': '公斤每立方米 (kg/m³)',
            'gram_per_cubic_centimeter': '克每立方厘米 (g/cm³)',
            'gram_per_cubic_meter': '克每立方米 (g/m³)',
            'gram_per_liter': '克每升 (g/L)',
            'gram_per_milliliter': '克每毫升 (g/mL)',
            'milligram_per_cubic_centimeter': '毫克每立方厘米 (mg/cm³)',
            'milligram_per_liter': '毫克每升 (mg/L)',
            'microgram_per_cubic_centimeter': '微克每立方厘米 (μg/cm³)',
            'microgram_per_liter': '微克每升 (μg/L)',
            'kilogram_per_liter': '公斤每升 (kg/L)',
            'kilogram_per_cubic_decimeter': '公斤每立方分米 (kg/dm³)',
            'kilogram_per_cubic_centimeter': '公斤每立方厘米 (kg/cm³)',
            'tonne_per_cubic_meter': '吨每立方米 (t/m³)',
            'tonne_per_cubic_kilometer': '吨每立方公里 (t/km³)',
            'megagram_per_cubic_meter': '兆克每立方米 (Mg/m³)',
            'pound_per_cubic_foot': '磅每立方英尺 (lb/ft³)',
            'pound_per_cubic_inch': '磅每立方英寸 (lb/in³)',
            'pound_per_cubic_yard': '磅每立方码 (lb/yd³)',
            'pound_per_gallon_us': '磅每加仑美制 (lb/gal)',
            'pound_per_gallon_imperial': '磅每加仑英制 (lb/gal)',
            'ounce_per_cubic_inch': '盎司每立方英寸 (oz/in³)',
            'ounce_per_cubic_foot': '盎司每立方英尺 (oz/ft³)',
            'ounce_per_gallon_us': '盎司每加仑美制 (oz/gal)',
            'ounce_per_gallon_imperial': '盎司每加仑英制 (oz/gal)',
            'ton_per_cubic_foot': '吨每立方英尺 (ton/ft³)',
            'ton_per_cubic_yard': '吨每立方码 (ton/yd³)',
            'ton_per_cubic_meter': '吨每立方米 (ton/m³)',
            'long_ton_per_cubic_yard': '长吨每立方码 (long ton/yd³)',
            'short_ton_per_cubic_yard': '短吨每立方码 (short ton/yd³)',
            'specific_gravity': '比重 (SG)',
            'degree_baume': '波美度 (°Bé)',
            'degree_api': 'API度 (°API)',
            'degree_brix': '白利糖度 (°Bx)',
            'degree_plato': '柏拉图度 (°P)',
            'degree_twaddell': '特瓦德尔度 (°Tw)',
            'atomic_mass_unit_per_cubic_angstrom': '原子质量单位每立方埃 (u/Ų)',
            'gram_per_mole_per_cubic_centimeter': '克每摩尔每立方厘米 (g/mol/cm³)',
            'kilogram_per_mole_per_cubic_meter': '公斤每摩尔每立方米 (kg/mol/m³)',
            'earth_density': '地球密度',
            'solar_density': '太阳密度',
            'water_density_4c': '4°C水密度',
            'air_density_stp': '标准状况空气密度',
            'cell_density': '细胞密度',
            'bone_density': '骨密度',
            'muscle_density': '肌肉密度',
            'fat_density': '脂肪密度',
            'bulk_density': '堆积密度',
            'apparent_density': '表观密度',
            'true_density': '真密度',
            'tap_density': '振实密度',
            'particle_density': '粒子密度',
            'grain_density': '颗粒密度',
            'packing_density': '堆积密度',
            'slug_per_cubic_foot': '斯勒格每立方英尺 (slug/ft³)',
            'grain_per_gallon_us': '格令每加仑美制 (gr/gal)',
            'grain_per_cubic_foot': '格令每立方英尺 (gr/ft³)',
            'pennyweight_per_cubic_inch': '本尼威特每立方英寸 (dwt/in³)',
            'livre_per_cubic_pied': '里弗每立方皮耶 (livre/pied³)',
            'pfund_per_cubic_fuss': '普芬德每立方富斯 (Pfund/Fuß³)',
            'catty_per_cubic_chi': '斤每立方尺 (斤/尺³)',
        },
        'ja': {
            'kilogram_per_cubic_meter': 'キログラム毎立方メートル (kg/m³)',
            'gram_per_cubic_centimeter': 'グラム毎立方センチメートル (g/cm³)',
            'gram_per_cubic_meter': 'グラム毎立方メートル (g/m³)',
            'gram_per_liter': 'グラム毎リットル (g/L)',
            'gram_per_milliliter': 'グラム毎ミリリットル (g/mL)',
            'milligram_per_cubic_centimeter': 'ミリグラム毎立方センチメートル (mg/cm³)',
            'milligram_per_liter': 'ミリグラム毎リットル (mg/L)',
            'microgram_per_cubic_centimeter': 'マイクログラム毎立方センチメートル (μg/cm³)',
            'microgram_per_liter': 'マイクログラム毎リットル (μg/L)',
            'kilogram_per_liter': 'キログラム毎リットル (kg/L)',
            'kilogram_per_cubic_decimeter': 'キログラム毎立方デシメートル (kg/dm³)',
            'kilogram_per_cubic_centimeter': 'キログラム毎立方センチメートル (kg/cm³)',
            'tonne_per_cubic_meter': 'トン毎立方メートル (t/m³)',
            'tonne_per_cubic_kilometer': 'トン毎立方キロメートル (t/km³)',
            'megagram_per_cubic_meter': 'メガグラム毎立方メートル (Mg/m³)',
            'pound_per_cubic_foot': 'ポンド毎立方フィート (lb/ft³)',
            'pound_per_cubic_inch': 'ポンド毎立方インチ (lb/in³)',
            'pound_per_cubic_yard': 'ポンド毎立方ヤード (lb/yd³)',
            'pound_per_gallon_us': 'ポンド毎ガロン（米）(lb/gal)',
            'pound_per_gallon_imperial': 'ポンド毎ガロン（英）(lb/gal)',
            'ounce_per_cubic_inch': 'オンス毎立方インチ (oz/in³)',
            'ounce_per_cubic_foot': 'オンス毎立方フィート (oz/ft³)',
            'ounce_per_gallon_us': 'オンス毎ガロン（米）(oz/gal)',
            'ounce_per_gallon_imperial': 'オンス毎ガロン（英）(oz/gal)',
            'ton_per_cubic_foot': 'トン毎立方フィート (ton/ft³)',
            'ton_per_cubic_yard': 'トン毎立方ヤード (ton/yd³)',
            'ton_per_cubic_meter': 'トン毎立方メートル (ton/m³)',
            'long_ton_per_cubic_yard': 'ロングトン毎立方ヤード (long ton/yd³)',
            'short_ton_per_cubic_yard': 'ショートトン毎立方ヤード (short ton/yd³)',
            'specific_gravity': '比重 (SG)',
            'degree_baume': 'ボーメ度 (°Bé)',
            'degree_api': 'API度 (°API)',
            'degree_brix': 'ブリックス度 (°Bx)',
            'degree_plato': 'プラトン度 (°P)',
            'degree_twaddell': 'トワッデル度 (°Tw)',
            'atomic_mass_unit_per_cubic_angstrom': '原子質量単位毎立方オングストローム (u/Ų)',
            'gram_per_mole_per_cubic_centimeter': 'グラム毎モル毎立方センチメートル (g/mol/cm³)',
            'kilogram_per_mole_per_cubic_meter': 'キログラム毎モル毎立方メートル (kg/mol/m³)',
            'earth_density': '地球の密度',
            'solar_density': '太陽の密度',
            'water_density_4c': '4°Cの水の密度',
            'air_density_stp': '標準状態の空気の密度',
            'cell_density': '細胞の密度',
            'bone_density': '骨の密度',
            'muscle_density': '筋肉の密度',
            'fat_density': '脂肪の密度',
            'bulk_density': 'かさ密度',
            'apparent_density': '見かけ密度',
            'true_density': '真密度',
            'tap_density': 'タップ密度',
            'particle_density': '粒子密度',
            'grain_density': '穀物密度',
            'packing_density': '充填密度',
            'slug_per_cubic_foot': 'スラグ毎立方フィート (slug/ft³)',
            'grain_per_gallon_us': 'グレーン毎ガロン（米）(gr/gal)',
            'grain_per_cubic_foot': 'グレーン毎立方フィート (gr/ft³)',
            'pennyweight_per_cubic_inch': 'ペニーウェイト毎立方インチ (dwt/in³)',
            'livre_per_cubic_pied': 'リーブル毎立方ピエ (livre/pied³)',
            'pfund_per_cubic_fuss': 'プフント毎立方フス (Pfund/Fuß³)',
            'catty_per_cubic_chi': '斤毎立方尺 (斤/尺³)',
        },
    }
}
