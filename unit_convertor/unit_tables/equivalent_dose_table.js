export const equivalentDoseTable = {
    ...
    'language': {
        ...
        'zh-CN': {
            'sievert': '希沃特 (Sv)',
            'millisievert': '毫希沃特 (mSv)',
            'microsievert': '微希沃特 (μSv)',
            'nanosievert': '纳希沃特 (nSv)',
            'picosievert': '皮希沃特 (pSv)',
            'femtosievert': '飞希沃特 (fSv)',
            'kilosievert': '千希沃特 (kSv)',
            'megasievert': '兆希沃特 (MSv)',
            'rem': '雷姆 (rem)',
            'millirem': '毫雷姆 (mrem)',
            'microrem': '微雷姆 (μrem)',
            'nanonem': '纳雷姆 (nrem)',
            'kilonem': '千雷姆 (krem)',
            'centisievert': '厘希沃特 (cSv)',
            'decisievert': '分希沃特 (dSv)',
            'sievert_per_hour': '希沃特每小时 (Sv/h)',
            'millisievert_per_hour': '毫希沃特每小时 (mSv/h)',
            'microsievert_per_hour': '微希沃特每小时 (μSv/h)',
            'nanosievert_per_hour': '纳希沃特每小时 (nSv/h)',
            'sievert_per_minute': '希沃特每分钟 (Sv/min)',
            'millisievert_per_minute': '毫希沃特每分钟 (mSv/min)',
            'microsievert_per_minute': '微希沃特每分钟 (μSv/min)',
            'sievert_per_second': '希沃特每秒 (Sv/s)',
            'millisievert_per_second': '毫希沃特每秒 (mSv/s)',
            'microsievert_per_second': '微希沃特每秒 (μSv/s)',
            'rem_per_hour': '雷姆每小时 (rem/h)',
            'millirem_per_hour': '毫雷姆每小时 (mrem/h)',
            'microrem_per_hour': '微雷姆每小时 (μrem/h)',
            'rem_per_minute': '雷姆每分钟 (rem/min)',
            'millirem_per_minute': '毫雷姆每分钟 (mrem/min)',
            'rem_per_second': '雷姆每秒 (rem/s)',
            'millirem_per_second': '毫雷姆每秒 (mrem/s)',
            'sievert_per_year': '希沃特每年 (Sv/year)',
            'millisievert_per_year': '毫希沃特每年 (mSv/year)',
            'microsievert_per_year': '微希沃特每年 (μSv/year)',
            'rem_per_year': '雷姆每年 (rem/year)',
            'millirem_per_year': '毫雷姆每年 (mrem/year)',
            'microrem_per_year': '微雷姆每年 (μrem/year)',
            'person_sievert': '人希沃特 (person-Sv)',
            'person_rem': '人雷姆 (person-rem)',
            'man_sievert': '人希沃特 (man-Sv)',
            'man_rem': '人雷姆 (man-rem)',
        },
        'ja': {
            'sievert': 'シーベルト (Sv)',
            'millisievert': 'ミリシーベルト (mSv)',
            'microsievert': 'マイクロシーベルト (μSv)',
            'nanosievert': 'ナノシーベルト (nSv)',
            'picosievert': 'ピコシーベルト (pSv)',
            'femtosievert': 'フェムトシーベルト (fSv)',
            'kilosievert': 'キロシーベルト (kSv)',
            'megasievert': 'メガシーベルト (MSv)',
            'rem': 'レム (rem)',
            'millirem': 'ミリレム (mrem)',
            'microrem': 'マイクロレム (μrem)',
            'nanonem': 'ナノレム (nrem)',
            'kilonem': 'キロレム (krem)',
            'centisievert': 'センチシーベルト (cSv)',
            'decisievert': 'デシシーベルト (dSv)',
            'sievert_per_hour': 'シーベルト毎時 (Sv/h)',
            'millisievert_per_hour': 'ミリシーベルト毎時 (mSv/h)',
            'microsievert_per_hour': 'マイクロシーベルト毎時 (μSv/h)',
            'nanosievert_per_hour': 'ナノシーベルト毎時 (nSv/h)',
            'sievert_per_minute': 'シーベルト毎分 (Sv/min)',
            'millisievert_per_minute': 'ミリシーベルト毎分 (mSv/min)',
            'microsievert_per_minute': 'マイクロシーベルト毎分 (μSv/min)',
            'sievert_per_second': 'シーベルト毎秒 (Sv/s)',
            'millisievert_per_second': 'ミリシーベルト毎秒 (mSv/s)',
            'microsievert_per_second': 'マイクロシーベルト毎秒 (μSv/s)',
            'rem_per_hour': 'レム毎時 (rem/h)',
            'millirem_per_hour': 'ミリレム毎時 (mrem/h)',
            'microrem_per_hour': 'マイクロレム毎時 (μrem/h)',
            'rem_per_minute': 'レム毎分 (rem/min)',
            'millirem_per_minute': 'ミリレム毎分 (mrem/min)',
            'rem_per_second': 'レム毎秒 (rem/s)',
            'millirem_per_second': 'ミリレム毎秒 (mrem/s)',
            'sievert_per_year': 'シーベルト毎年 (Sv/year)',
            'millisievert_per_year': 'ミリシーベルト毎年 (mSv/year)',
            'microsievert_per_year': 'マイクロシーベルト毎年 (μSv/year)',
            'rem_per_year': 'レム毎年 (rem/year)',
            'millirem_per_year': 'ミリレム毎年 (mrem/year)',
            'microrem_per_year': 'マイクロレム毎年 (μrem/year)',
            'person_sievert': '人シーベルト (person-Sv)',
            'person_rem': '人レム (person-rem)',
            'man_sievert': '人シーベルト (man-Sv)',
            'man_rem': '人レム (man-rem)',
        },
    },
    'reference_values': {
